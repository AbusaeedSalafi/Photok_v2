...
class ChangePasswordViewModel @Inject constructor(
    ...
    var changePasswordState: ChangePasswordState = ChangePasswordState.START
        set(value) {
            field = value
            notifyChange(com.lockmedia.applock.BR.changePasswordState, value)
        }
    ...
    var oldPassword: String = String.empty
        set(value) {
            field = value
            notifyChange(com.lockmedia.applock.BR.oldPassword, value)
        }
    ...
    var newPassword: String = String.empty
        set(value) {
            field = value
            notifyChange(com.lockmedia.applock.BR.newPassword, value)
        }
    ...
    var newPasswordConfirm: String = String.empty
        set(value) {
            field = value
            notifyChange(com.lockmedia.applock.BR.newPasswordConfirm, value)
        }
