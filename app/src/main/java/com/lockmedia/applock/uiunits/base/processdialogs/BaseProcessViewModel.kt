...
abstract class BaseProcessViewModel<T>(app: Application) : ObservableViewModel(app) {
    ...
    var processState: ProcessState = ProcessState.INITIALIZE
        set(value) {
            field = value
            notifyChange(com.lockmedia.applock.BR.processState, value)
        }
    ...
    var progressPercent: Int = 0
        set(value) {
            field = value
            notifyChange(com.lockmedia.applock.BR.progressPercent, value)
        }
    ...
    var current: Int = 0
        set(value) {
            field = value
            notifyChange(com.lockmedia.applock.BR.current, value)
        }
    ...
    var elementsToProcess = 0
        set(value) {
            field = value
            notifyChange(com.lockmedia.applock.BR.elementsToProcess, value)
        }
