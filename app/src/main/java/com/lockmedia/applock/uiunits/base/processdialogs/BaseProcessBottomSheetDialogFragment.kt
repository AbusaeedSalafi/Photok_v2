...
package com.lockmedia.applock.uiunits.base.processdialogs
...
import com.lockmedia.applock.databinding.DialogBottomSheetProcessBinding
import com.lockmedia.applock.other.extensions.hide
import com.lockmedia.applock.other.extensions.show
import com.lockmedia.applock.other.extensions.vanish
...
abstract class BaseProcessBottomSheetDialogFragment<T>(
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.addOnPropertyChange<ProcessState>(com.lockmedia.applock.BR.processState) {
