...
package com.lockmedia.applock.models.database.entity
...
data class Photo(
    ...
    companion object {
         ...
         * Sample: 923ae2b7-f056-453d-a3dc-264a08e58a07.applock
         */
        fun internalFileName(uuid: String) = "${uuid}.applock"

        /**
         * Get FileName for internal thumbnails.
         * Sample: 923ae2b7-f056-453d-a3dc-264a08e58a07.applock.tn
         */
        fun internalThumbnailFileName(uuid: String) = "${uuid}.applock.tn"

        /**
         * Get FileName for video previews.
         * Sample: 923ae2b7-f056-453d-a3dc-264a08e58a07.applock.vp
         */
        fun internalVideoPreviewFileName(uuid: String) = "${uuid}.applock.vp"
    }
}