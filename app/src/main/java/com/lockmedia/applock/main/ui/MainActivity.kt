...
package com.lockmedia.applock.main.ui
...
import com.lockmedia.applock.databinding.ActivityMainBinding
import com.lockmedia.applock.gallerymedia.ui.importing.ImportBottomSheetDialogFragment
import com.lockmedia.applock.other.REQ_PERM_SHARED_IMPORT
import com.lockmedia.applock.other.extensions.getBaseApplication
import com.lockmedia.applock.other.extensions.setNavBarColorRes
import com.lockmedia.applock.apppermissions.getReadImagesPermission
import com.lockmedia.applock.apppermissions.getReadVideosPermission
import com.lockmedia.applock.settings.data.Config
import com.lockmedia.applock.uiunits.Dialogs
import com.lockmedia.applock.uiunits.bindings.BindableActivity
...
class MainActivity : BindableActivity<ActivityMainBinding>(R.layout.activity_main) {
    ...
    override fun onPostCreate(savedInstanceState: Bundle?) {
        ...
        getBaseApplication().rawApplicationState.observe(this) {
            if (it == com.lockmedia.applock.ApplicationState.UNLOCKED) {
