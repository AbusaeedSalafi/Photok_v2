...
import com.lockmedia.applock.databinding.FragmentVideoPlayerBinding
import com.lockmedia.applock.other.INTENT_PHOTO_ID
import com.lockmedia.applock.other.extensions.hideSystemUI
...
class VideoPlayerFragment :
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.addOnPropertyChange<SimpleExoPlayer?>(com.lockmedia.applock.BR.player) {
